...
public class EntityThrownApple extends EntityThrowable {

	private double damage = 2.0D;
	public int knockbackStrength;
	
public EntityThrownApple(World world) {
super(world);
}

public EntityThrownApple(World world, EntityLivingBase entity) {
super(world, entity);
}

public EntityThrownApple(World world, double x, double y, double z) {
super(world, x, y, z);
}
