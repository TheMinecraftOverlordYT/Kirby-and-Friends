...
public class LaserGun extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(KirbyMod.Ruby))
        {
            ...
            {
                par3EntityPlayer.inventory.consumeInventoryItem(KirbyMod.Ruby);
            }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(KirbyMod.Ruby))
        {
