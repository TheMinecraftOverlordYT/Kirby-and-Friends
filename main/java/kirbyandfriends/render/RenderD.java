...
public class RenderD extends RenderPlayer {
	 private static final ResourceLocation sheepTextures = new ResourceLocation("textures/entity/sheep/sheep_fur.png");
	    ...
	    public RenderD(ModelBase p_i1266_1_, ModelBase p_i1266_2_, float p_i1266_3_)
	    {
	        super();
...
//	    {
//	        return this.shouldRenderPass((Entity)p_77032_1_, p_77032_2_, p_77032_3_);
//	    }
