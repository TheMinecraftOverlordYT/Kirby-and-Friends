...
import kirbyandfriends.blocks.*;
import kirbyandfriends.entities.*;
import kirbyandfriends.items.*;
import kirbyandfriends.render.RenderEntityZombiePig;
import kirbyandfriends.render.RenderGhost;
import kirbyandfriends.render.RenderHerobrine;
import kirbyandfriends.render.RenderHuman;
import kirbyandfriends.render.RenderKillerKirby;
import kirbyandfriends.render.RenderKirby;
import kirbyandfriends.render.RenderLaser;
import kirbyandfriends.render.RenderNotch;
import kirbyandfriends.render.RenderPigman;
import kirbyandfriends.render.RenderQuark;
import kirbyandfriends.render.RenderZombieNew;
...
public class KirbyMod {
	...
	public void load(FMLInitializationEvent event)
	{
		...
		BlockCryingObsidian = new BlockCryingObsidian().setBlockName("CryingObsidian"); 
		 ...
		 EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityHuman.class, "Human", ++entityid, this, 43, 3, true);
		 EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityKirby.class, "Kirby", ++entityid, this, 43, 3, true);
		 EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityNewSnowman.class, "Snowman", ++entityid, this, 45, 3, true);
		  EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityKillerKirby.class, "KillerKirby", ++entityid, this, 50, 3, true);
		  EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityZombiePig.class, "Zombie Pig", ++entityid, this, 50, 3, true);
		  EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityQuark.class, "Quark", ++entityid, this, 40, 3, true);
		 //EntityRegistry.registerModEntity(kirbyandfriends.entities.EntityRana.class, "Rana", ++entityid, this, 70, 3, true);
		...
		EntityRegistry.addSpawn(kirbyandfriends.entities.EntityPigman.class, 15, PigmanSpawnRate, 4, EnumCreatureType.ambient, BiomeGenBase.plains);
		 EntityRegistry.addSpawn(kirbyandfriends.entities.EntityKirby.class, 15, KirbySpawnRate, 4, EnumCreatureType.ambient, BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityNotch.class, 20, NotchSpawnRate, 4, EnumCreatureType.ambient, BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityHuman.class, 18, HumanSpawnRate, 4, EnumCreatureType.ambient,BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityGhost.class, 22, GhostSpawnRate, 4, EnumCreatureType.creature,BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityHerobrine.class, 22, HerobrineSpawnRate, 4, EnumCreatureType.monster,BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityZombiePig.class, 16, ZombiePigSpawnRate, 4, EnumCreatureType.monster,BiomeGenBase.plains);
			//EntityRegistry.addSpawn(kirbyandfriends.entities.EntityNewSnowman.class, 17, SnowmanSpawnRate, 4, EnumCreatureType.monster,BiomeGenBase.coldTaigaHills);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityKillerKirby.class, KillerKirbySpawnRate, 2, 4, EnumCreatureType.monster,BiomeGenBase.plains);
			//EntityRegistry.addSpawn(kirbyandfriends.entities.EntityRana.class, 19, 2, 4, EnumCreatureType.creature,BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityQuark.class, 21, QuarkSpawnRate, 4, EnumCreatureType.creature,BiomeGenBase.plains);
			EntityRegistry.addSpawn(kirbyandfriends.entities.EntityZombieNew.class, 22, NewZombieSpawnRate, 4, EnumCreatureType.monster,BiomeGenBase.plains);
